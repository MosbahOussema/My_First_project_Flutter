...
class _ContactState extends State<Contact> {
  List<ContactItem> contacts = [
    ContactItem(
        id: 1, name: "Ambulance", phone: "198", icon: Icons.person, type: 1),
    ContactItem(
        id: 2, name: "Police", phone: "197", icon: Icons.person, type: 1),
    ContactItem(
  ...
  List<String> categories = ['SOS', 'Family', 'Friends', 'Doctors'];
                                ...
                                children: [
                                  Expanded(
                                    child: IconButton(
                                      ...
                                      onPressed: () {
                                        contactSelected[index].phone!.length ==
                                                8
                                            // ignore: deprecated_member_use
                                            ? launch(
                                                "tel://+216${contactSelected[index].phone!}")
                                            // ignore: deprecated_member_use
                                            : launch(
                                                "tel://${contactSelected[index].phone!}");
                                      },
                                    ),
                                  ),
                                  SizedBox(
